...
type DesignSystemPreviewSurface = (typeof surfaces)[number];

function FoundationSurface({
	surface,
}: {
	index: number;
	surface: DesignSystemPreviewSurface;
}) {
