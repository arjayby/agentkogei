...
:root {
	...
	--foundation-info: oklch(0.55 0.12 230);
...
.dark {
	...
	--foundation-info: oklch(0.74 0.1 230);
...
Foundation's AgentKogei-authored prose, tokens, examples, and original visual resources are licensed under CC BY 4.0. You may share and adapt them for any purpose provided you give appropriate credit, link to the license, and indicate changes. The full legal code is available at https://creativecommons.org/licenses/by/4.0/legalcode.

## Attribution and provenance

Foundation 1.1.0 was authored by AgentKogei in 2026 and is distributed under CC BY 4.0. Suggested attribution: “Foundation Interface System by AgentKogei, licensed under CC BY 4.0; changes were made.”

All prose, semantic token selections, examples, and evaluation materials in this Pack Release are original AgentKogei work. The release contains no third-party assets, fonts, source code, or remote resources. References to React, Next.js, Tailwind CSS, shadcn/ui, WCAG, and Creative Commons identify compatibility or standards and do not incorporate their content.
...
- Pack Release: 1.1.0, published 2026-07-19 by AgentKogei
- Pack License: Creative Commons Attribution 4.0 International (CC-BY-4.0), https://creativecommons.org/licenses/by/4.0/
- Attribution: Foundation Interface System by AgentKogei, licensed under CC BY 4.0.
